...
parser = argparse.ArgumentParser(
    description='Download and store files from a HAR file containing "emoji" URLs.'
)
parser.add_argument("har_file", help="Path to the HAR file")
parser.add_argument(
    "--folder", "-f", help="Destination folder for downloaded files", default="./"
)
